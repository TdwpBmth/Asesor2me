                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            if($usuario!=null){
                                echo"
                                <form class='form-signin' action='procedareditado.php' method='POST'>
                                <div class='form-label-group'>
                                    <input name='nombre' type='text' id='inputNombre' class='form-control'
                                        placeholder='Nombre' required value='$usuario->nombre' autofocus>
                                    <label for='inputNombre'>Nombre</label>
                                </div>
                                <div class='form-label-group'>
                                    <input name='id' type='number' id='inputId' class='form-control'
                                        placeholder='ID' required value='$usuario->id' hidden>
